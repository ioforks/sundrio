...
public class ClassDef extends AbstractTypeDef<io.sundr.codegen.model.ClassDef, ClassDefBuilder> {

    public static io.sundr.codegen.model.ClassDef OBJECT = new ClassDefBuilder()
    ...
    public static Set<ClassRef> EXTENDS_OBJECT = new LinkedHashSet<ClassRef>(Arrays.asList(OBJECT_REF));
     ...
     * @return
     */
    private static Set<Method> adaptConstructors(Set<Method> methods, io.sundr.codegen.model.ClassDef target) {
    ...
    public boolean isAssignableFrom(io.sundr.codegen.model.ClassDef o) {
    ...
    public boolean equals(Object o) {
        ...
        io.sundr.codegen.model.ClassDef typeDef = (io.sundr.codegen.model.ClassDef) o;
