...
public class MethodFluentImpl<A extends MethodFluent<A>> extends ModifierSupportFluentImpl<A> implements MethodFluent<A> {
    ...
    Set<VisitableBuilder<TypeParamDef, ?>> parameters = new LinkedHashSet();
    String name;
    TypeRef returnType;
    List<VisitableBuilder<Property, ?>> arguments = new ArrayList();
    boolean varArgPreferred;
    Set<VisitableBuilder<ClassRef, ?>> exceptions = new LinkedHashSet();
    VisitableBuilder<Block, ?> block;
