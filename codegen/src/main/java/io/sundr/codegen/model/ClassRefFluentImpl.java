...
public class ClassRefFluentImpl<A extends ClassRefFluent<A>> extends AbstractTypeRefFluentImpl<A> implements ClassRefFluent<A>{
    ...
    private VisitableBuilder<? extends ClassDef,?> definition;
    ...
    public A withDefinition(ClassDef definition){
            if (definition!=null){ this.definition= new ClassDefBuilder(definition); _visitables.add(this.definition);} return (A) this;
    }
    ...
    public class DefinitionNestedImpl<N> extends ClassDefFluentImpl<ClassRefFluent.DefinitionNested<N>> implements ClassRefFluent.DefinitionNested<N>,Nested<N>{
            ...
            DefinitionNestedImpl(ClassDef item){
    ...
    public class EnumConstantRefArgumentsNestedImpl<N> extends EnumConstantRefFluentImpl<ClassRefFluent.EnumConstantRefArgumentsNested<N>> implements ClassRefFluent.EnumConstantRefArgumentsNested<N>,Nested<N>{
    ...
    public N and(){
            return (N) ClassRefFluentImpl.this.addToEnumConstantRefArguments(builder.build());
    }
